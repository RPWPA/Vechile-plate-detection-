...
Mfill2=imread('char/Mfill2.bmp');
Qfill=imread('char/fillQ.bmp');
Mfill=imread('char/Mfill.bmp');
...
fivefill=imread('char/5fill.bmp');




%*-*-*-*-*-*-*-*-*-*-*-
letter=[A Afill B Bfill C D Dfill E F G H I J K L M N O Ofill P Mfill2 Q Qfill R Mfill S T U V W X Y Z];

number=[one two three four fourfill five six sixfill sixfill2 seven eight eightfill nine ninefill fivefill zero zerofill];
